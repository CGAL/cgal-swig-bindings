...
poly_simplified = CGAL_Polyline_simplification_2.simplify(poly, Squared_distance_cost(), Stop_below_count_ratio_threshold(0.5))

# test point version
outlist = []
CGAL_Polyline_simplification_2.simplify(ptlst, Squared_distance_cost(), Stop_below_count_ratio_threshold(0.5), outlist)
...
CGAL_Polyline_simplification_2.simplify(cdt, Squared_distance_cost(), Stop_below_count_ratio_threshold(0.5))
...
print("Vertices of third polyline, note the last vertex is duplicated since it is closed")
