...
# Insertions
idx = points.insert()
print("Point " + str(idx) + " inserted = " + str(points.point(idx)))
...
print("Point " + str(idx) + " inserted = " + str(points.point(idx)) + ", " + str(points.normal(idx)))

# Access/modification through normal map
normal_map = points.normal_map()
if normal_map.is_valid:
    print("Normal 3 = " + str(normal_map.get(3)))
    normal_map.set(2, Vector_3 (1, 2, 3))
    print("Normal 2 = " + str(normal_map.get(2)))
...
points.remove(2)
print("Point set has " + str(points.size()) + " point(s) and " + str(points.garbage_size()) + " garbage point(s)")

# Iterate and display points+normals through indices
print("Point set:")
for idx in points.indices():
    print(" " + str(idx) + ". Point = (" + str(points.point(idx)) + "), Normal = (" + str(points.normal(idx)) + ")")
...
if intensity.is_valid():
    ...
    # Display properties
    print("Point set has the following properties: " + str(points.properties()))
    ...
    for idx in points.indices():
        print (" * Intensity " + str(idx) + " = " + str(intensity.get(idx)))
...
points.clear()
points = Point_set_3(datafile) # or points.read(sys.argv[1])
print(datafile + " has " + str(points.size()) + " point(s) and " + str(points.garbage_size()) + " garbage point(s)")
print(datafile + " has the following properties: " + str(points.properties()))
