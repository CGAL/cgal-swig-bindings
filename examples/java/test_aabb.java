...
import CGAL.Polyhedron_3.Polyhedron_3_Edge_handle;
import CGAL.AABB_tree.AABB_tree_Polyhedron_3_Facet_handle;
import CGAL.AABB_tree.AABB_tree_Polyhedron_3_Edge_handle;
import CGAL.AABB_tree.AABB_tree_Triangle_3_soup;
import CGAL.AABB_tree.Point_and_Polyhedron_3_Edge_handle;
...
import CGAL.AABB_tree.Object_and_Polyhedron_3_Edge_handle;
...
public class test_aabb {
  ...
  public static void main(String arg[]){
    ...
    AABB_tree_Polyhedron_3_Edge_handle tree2=new AABB_tree_Polyhedron_3_Edge_handle(poly.edges());
    ...
    LinkedList<Polyhedron_3_Edge_handle> lst_hh = new LinkedList<Polyhedron_3_Edge_handle>();
    ...
    Point_and_Polyhedron_3_Edge_handle pair_phh=tree2.closest_point_and_primitive(new Point_3(5,0,0.5));
    Polyhedron_3_Edge_handle hh=pair_phh.getSecond();
    ...
    LinkedList<Object_and_Polyhedron_3_Edge_handle> lst_ohh = new LinkedList<Object_and_Polyhedron_3_Edge_handle>();
