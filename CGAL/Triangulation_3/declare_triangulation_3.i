...
%define Declare_triangulation_3_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE,POINT_TYPE,WTAG)
  //Handles
  %template(CLASSNAME_PREFIX##_Cell_handle)        CGAL_Cell_handle<CPPTYPE,POINT_TYPE>;
  %typemap(javaimports) CGAL_Vertex_handle %{import CGAL.Kernel.POINT_TYPE;%}
  %template(CLASSNAME_PREFIX##_Vertex_handle)      CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>;

  %include "std_pair.i"
  %template(CLASSNAME_PREFIX##_Facet) std::pair<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int>;
  %template(CLASSNAME_PREFIX##_Edge)  CGAL_SWIG::Triple<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int,int>;

  //typemaps for Output iterators
  %define CLASSNAME_PREFIX##_Cell_handle_output_iterator  Triangulation_3_wrapper<CPPTYPE,POINT_TYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>,CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,WTAG >::Cell_handle_output_iterator %enddef
  %define CLASSNAME_PREFIX##_Vertex_handle_output_iterator  Triangulation_3_wrapper<CPPTYPE,POINT_TYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>,CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,WTAG >::Vertex_handle_output_iterator %enddef
  %define CLASSNAME_PREFIX##_Facet_output_iterator  Triangulation_3_wrapper<CPPTYPE,POINT_TYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>,CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,WTAG >::Facet_output_iterator %enddef
  %define CLASSNAME_PREFIX##_Edge_output_iterator  Triangulation_3_wrapper<CPPTYPE,POINT_TYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>,CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,WTAG >::Edge_output_iterator %enddef
  %{
  typedef CGAL_Cell_handle<CPPTYPE,POINT_TYPE>                              CLASSNAME_PREFIX##_Cell_handle;
  typedef CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>                            CLASSNAME_PREFIX##_Vertex_handle;
  ...
  //Triangulation
  %typemap(javaimports)  Triangulation_3_wrapper%{import CGAL.Kernel.POINT_TYPE; import java.util.Iterator; import java.util.Collection;%}
  %template(EXPOSEDNAME) Triangulation_3_wrapper<CPPTYPE,POINT_TYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE>,CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,WTAG >;


  //Iterators and circulators
  Iterator_for_java(CGAL_All_vertices_iterator,CLASSNAME_PREFIX##_Vertex_handle,import CGAL.Kernel.POINT_TYPE;)
  %template(CLASSNAME_PREFIX##_All_vertices_iterator) CGAL_All_vertices_iterator<CPPTYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE> >;

  Iterator_for_java(CGAL_Finite_vertices_iterator,CLASSNAME_PREFIX##_Vertex_handle,import CGAL.Kernel.POINT_TYPE;)
  %template(CLASSNAME_PREFIX##_Finite_vertices_iterator) CGAL_Finite_vertices_iterator<CPPTYPE,CGAL_Vertex_handle<CPPTYPE,POINT_TYPE> >;

  Iterator_for_java(CGAL_All_cells_iterator,CLASSNAME_PREFIX##_Cell_handle,)
  %template(CLASSNAME_PREFIX##_All_cells_iterator) CGAL_All_cells_iterator<CPPTYPE,CGAL_Cell_handle<CPPTYPE,POINT_TYPE> >;

  Iterator_for_java(CGAL_Finite_cells_iterator,CLASSNAME_PREFIX##_Cell_handle,)
  %template(CLASSNAME_PREFIX##_Finite_cells_iterator) CGAL_Finite_cells_iterator<CPPTYPE,CGAL_Cell_handle<CPPTYPE,POINT_TYPE> >;

  Iterator_for_java(CGAL_All_facets_iterator,CLASSNAME_PREFIX##_Facet,)
  %template(CLASSNAME_PREFIX##_All_facets_iterator) CGAL_All_facets_iterator<CPPTYPE,std::pair<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int> >;

  Iterator_for_java(CGAL_Finite_facets_iterator,CLASSNAME_PREFIX##_Facet,)
  %template(CLASSNAME_PREFIX##_Finite_facets_iterator) CGAL_Finite_facets_iterator<CPPTYPE,std::pair<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int> >;

  Iterator_for_java(CGAL_All_edges_iterator,CLASSNAME_PREFIX##_Edge,)
  %template(CLASSNAME_PREFIX##_All_edges_iterator) CGAL_All_edges_iterator<CPPTYPE,CGAL_SWIG::Triple<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int,int> >;

  Iterator_for_java(CGAL_Finite_edges_iterator,CLASSNAME_PREFIX##_Edge,)
  %template(CLASSNAME_PREFIX##_Finite_edges_iterator) CGAL_Finite_edges_iterator<CPPTYPE,CGAL_SWIG::Triple<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int,int> >;
  ...
  %template(CLASSNAME_PREFIX##_Cell_circulator) CGAL_Cell_circulator<CPPTYPE,CGAL_Cell_handle<CPPTYPE,POINT_TYPE> >;

  Iterator_for_java(CGAL_Facet_circulator,CLASSNAME_PREFIX##_Facet,)
  %template(CLASSNAME_PREFIX##_Facet_circulator) CGAL_Facet_circulator<CPPTYPE,std::pair<CGAL_Cell_handle<CPPTYPE,POINT_TYPE>,int> >;
%enddef
