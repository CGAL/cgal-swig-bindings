...
//  %typemap(javaimports)          Delaunay_triangulation_3_wrapper%{import CGAL.Kernel.Point_3; import CGAL.Kernel.Segment_3; import CGAL.Kernel.Triangle_3; import java.util.Iterator; import java.util.Collection;%}
  %typemap(javaimports)          Delaunay_triangulation_3_wrapper%{import CGAL.Kernel.Point_3; import java.util.Iterator; import java.util.Collection;%}
