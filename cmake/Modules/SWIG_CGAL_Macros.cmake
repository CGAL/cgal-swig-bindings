...
MACRO(ADD_SWIG_CGAL_PYTHON_MODULE packagename)
  ...
  if(BUILD_PYTHON)
    ...
    install (FILES ${PYTHON_OUTDIR_PREFIX}/CGAL/${MODULENAME}.py DESTINATION ${Python_SITELIB}/CGAL)
    if (CMAKE_VERSION VERSION_LESS 3.13)
      install (TARGETS ${SWIG_MODULE_${MODULENAME}_REAL_NAME} DESTINATION ${Python_SITEARCH}/CGAL)
    else ()
      install (TARGETS ${MODULENAME}_python DESTINATION ${Python_SITEARCH}/CGAL)
    endif ()
  endif()
