...
import CGAL.Triangulation_3.DT3_Facet;
import CGAL.Triangulation_3.DT3_Edge;
import CGAL.Triangulation_3.DT3_Cell_handle;
...
public class test2 {
  ...
  DT3_Vertex_handle v1=t.insert(new Point_3(1,1,1));
  DT3_Vertex_handle v2=t.insert(new Point_3(1,1,15),v1);
  DT3_Vertex_handle v3=t.insert(new Point_3(154,11,5),v2.cell());
  DT3_Vertex_handle v4=t.insert(new Point_3(14,0,45));
  ...
  for (DT3_Cell_handle ch : out.objects()){
    DT3_Cell_handle ch_tmp=new DT3_Cell_handle();
