...
public class Mesh2Criteria {
  ...
  public int evaluate(Quality_pair obj)
  {
    System.out.println(".....Call 1...");
    return Face_badness.NOT_BAD.swigValue();
  }
  
  public int evaluate(Mesh_2_Constrained_Delaunay_triangulation_2_Face_handle fh,Quality_pair obj)
  {
    System.out.println(".....Call 2...");
    obj=new Quality_pair();
    return Face_badness.NOT_BAD.swigValue();
