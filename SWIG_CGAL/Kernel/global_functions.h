...
#ifndef SWIG_CGAL_KERNEL_GLOBAL_FUNCTIONS_H
#define SWIG_CGAL_KERNEL_GLOBAL_FUNCTIONS_H
...
#undef SWIG_CGAL_FORWARD_CALL_GF_1
#undef SWIG_CGAL_FORWARD_CALL_GF_2
#undef SWIG_CGAL_FORWARD_AND_FILTER_CALL_GF_2
#undef SWIG_CGAL_FORWARD_CALL_GF_3
#undef SWIG_CGAL_FORWARD_CALL_GF_4
#undef SWIG_CGAL_FORWARD_CALL_GF_5
#undef SWIG_CGAL_FORWARD_CALL_GF_6
#undef SWIG_CGAL_FORWARD_CALL_GF_7

#endif //SWIG_CGAL_KERNEL_GLOBAL_FUNCTIONS_H
