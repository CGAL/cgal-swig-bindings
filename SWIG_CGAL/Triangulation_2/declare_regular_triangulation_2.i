...
%define Declare_regular_triangulation_2_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE)
  ...
  %template(CLASSNAME_PREFIX##_Hidden_vertices_iterator) SWIG_CGAL_Iterator<CPPTYPE::Hidden_vertices_iterator,SWIG_Triangulation_2::CGAL_Vertex_handle<CPPTYPE,Weighted_point_2> >;
