...
%define SWIG_CGAL_declare_constrained_Delaunay_triangulation_plus_2_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE,MODULENAME)
  ...
  //Iterators
  SWIG_CGAL_set_as_java_iterator(SWIG_CGAL_Iterator,CLASSNAME_PREFIX##_Constraint_id,)
  SWIG_CGAL_declare_identifier_of_template_class(CLASSNAME_PREFIX##_Constraint_iterator,SWIG_CGAL_Iterator<CPPTYPE::Constraint_iterator,Constraint_id_wrapper<CPPTYPE> >)
