...
%define Declare_triangulation_2_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE,POINT_TYPE,WTAG)
  ...
  SWIG_CGAL_set_as_java_iterator(CGAL_All_faces_iterator,CLASSNAME_PREFIX##_Face_handle,)
  ...
  SWIG_CGAL_set_as_java_iterator(CGAL_Finite_faces_iterator,CLASSNAME_PREFIX##_Face_handle,)
  ...
  SWIG_CGAL_set_as_java_iterator(CGAL_Line_face_circulator,CLASSNAME_PREFIX##_Face_handle,)
  ...
  SWIG_CGAL_set_as_java_iterator(CGAL_Face_circulator,CLASSNAME_PREFIX##_Face_handle,)
  ...
  SWIG_CGAL_set_as_java_iterator(CGAL_Edge_circulator,CLASSNAME_PREFIX##_Edge,)
  ...
  SWIG_CGAL_set_as_java_iterator(CGAL_Edge_circulator,CLASSNAME_PREFIX##_Vertex_handle,import CGAL.Kernel.POINT_TYPE;)
