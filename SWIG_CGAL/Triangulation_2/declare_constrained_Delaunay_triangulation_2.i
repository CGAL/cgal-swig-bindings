...
%define SWIG_CGAL_declare_constrained_Delaunay_triangulation_2_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE)
  SWIG_CGAL_declare_constrained_triangulation_2_internal(Internal_Contrained_triangulation_2_##EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE)
...
// --CPPTYPE is the c++ type of the triangulation
%define SWIG_CGAL_declare_constrained_Delaunay_triangulation_2(CLASSNAME,CPPTYPE)
  SWIG_CGAL_declare_constrained_Delaunay_triangulation_2_internal(CLASSNAME,CLASSNAME,CPPTYPE)
%enddef
