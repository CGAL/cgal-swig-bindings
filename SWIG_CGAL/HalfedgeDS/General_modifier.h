...
#ifndef SWIG_CGAL_HALFEDGEDS_GENERAL_MODIFIER_H
#define SWIG_CGAL_HALFEDGEDS_GENERAL_MODIFIER_H
...
public:
    ...
    void end_surface(){}
    void add_vertex(const Point_2& p){points.push_back(p.get_data());}
...
#endif //SWIG_CGAL_HALFEDGEDS_GENERAL_MODIFIER_H
