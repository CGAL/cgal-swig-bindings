...
//this macro declare global functions which arguments contains criteria
//--C3T3 the Complex_3_in_triangulation_3 type
//--DOMAIN the domain type
//--CRITERIA the criteria type
//--PARAMETERS the parameters type
%define declare_global_functions_with_criteria(C3T3,DOMAIN,CRITERIA,PARAMETERS)
...
//this macro declare global functions for a quadruple of type
//--C3T3 the Complex_3_in_triangulation_3 type
//--DOMAIN the domain type
//--CRITERIA the criteria type
//--PARAMETERS the parameters type
%define declare_global_functions(C3T3,DOMAIN,CRITERIA,PARAMETERS)
//global functions
...
%enddef //declare_global_functions
