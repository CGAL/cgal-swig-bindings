...
//Queries
  ...
  FORWARD_CALL_AND_REF_1(Vertex_handle,nearest_power_vertex,Weighted_point_3)
  FORWARD_CALL_AND_REF_2(Vertex_handle,nearest_power_vertex,Weighted_point_3,Cell_handle)
  FORWARD_CALL_AND_REF_2(Vertex_handle,nearest_power_vertex_in_cell,Weighted_point_3,Cell_handle)
