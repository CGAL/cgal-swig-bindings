...
%define SWIG_CGAL_declare_regular_triangulation_3_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE,MEMHOLDER)
...
// --CPPTYPE is the c++ type of the triangulation
%define SWIG_CGAL_declare_regular_triangulation_3(CLASSNAME,CPPTYPE)
  SWIG_CGAL_declare_regular_triangulation_3_internal(CLASSNAME,CLASSNAME,CPPTYPE,void*)
%enddef
...
%define SWIG_CGAL_declare_regular_triangulation_3_with_memory_holder(CLASSNAME,CPPTYPE,MEMHOLDER)
  SWIG_CGAL_declare_regular_triangulation_3_internal(CLASSNAME,CLASSNAME,CPPTYPE,MEMHOLDER)
%enddef
