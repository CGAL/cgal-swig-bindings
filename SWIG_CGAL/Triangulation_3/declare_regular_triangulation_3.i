...
%define Declare_regular_triangulation_3_internal(EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE,MEMHOLDER)
  Declare_triangulation_3_internal(Internal_Triangulation_3_##EXPOSEDNAME,CLASSNAME_PREFIX,CPPTYPE,Weighted_point_3,CGAL::Tag_true,MEMHOLDER)
  ...
  %template(EXPOSEDNAME)         Regular_triangulation_3_wrapper<CPPTYPE,SWIG_Triangulation_3::CGAL_Vertex_handle<CPPTYPE,Weighted_point_3>,SWIG_Triangulation_3::CGAL_Cell_handle<CPPTYPE,Weighted_point_3>,MEMHOLDER >;  
%enddef
...
%define Declare_regular_triangulation_3(CLASSNAME,CPPTYPE)
  Declare_regular_triangulation_3_internal(CLASSNAME,CLASSNAME,CPPTYPE,void*)
%enddef
  
//Expose a Regular_triangulation_3 with a memory holder
// --CLASSNAME  is the name of the class exposed by SWIG
// --CPPTYPE is the c++ type of the triangulation
// --MEMHOLDER is used if the triangulation pointer is hold by another class
%define Declare_regular_triangulation_3_with_memory_holder(CLASSNAME,CPPTYPE,MEMHOLDER)
  Declare_regular_triangulation_3_internal(CLASSNAME,CLASSNAME,CPPTYPE,MEMHOLDER)
%enddef
