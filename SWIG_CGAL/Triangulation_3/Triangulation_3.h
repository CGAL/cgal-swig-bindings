...
//Assignment
  ...
  #endif
  FORWARD_CALL_0_PTR(void,clear)  
//Access Functions
//Non const access
  FORWARD_CALL_0_PTR(int, dimension)
  FORWARD_CALL_0_PTR(int, number_of_vertices)
  FORWARD_CALL_0_PTR(int, number_of_cells)
  FORWARD_CALL_AND_REF_0_PTR(Vertex_handle,infinite_vertex)
  FORWARD_CALL_AND_REF_0_PTR(Cell_handle,infinite_cell)  
//Non-constant-time access functions
  FORWARD_CALL_0_PTR(int, number_of_facets)
  FORWARD_CALL_0_PTR(int, number_of_edges)
  FORWARD_CALL_0_PTR(int, number_of_finite_cells)
  FORWARD_CALL_0_PTR(int, number_of_finite_facets)
  FORWARD_CALL_0_PTR(int, number_of_finite_edges)  
//Geometric access functions
//Tests for Finite and Infinite Vertices and Faces
  FORWARD_CALL_1_PTR(bool,is_infinite,Vertex_handle)
  FORWARD_CALL_1_PTR(bool,is_infinite,Cell_handle)
  FORWARD_CALL_2_PTR(bool,is_infinite,Cell_handle,int)
  FORWARD_CALL_1_PTR(bool,is_infinite,Facet)
  FORWARD_CALL_3_PTR(bool,is_infinite,Cell_handle,int,int)  
  FORWARD_CALL_1_PTR(bool,is_infinite,Edge)
//Queries
  FORWARD_CALL_1_PTR(bool,is_vertex,Vertex_handle)
  FORWARD_CALL_1_PTR(bool,is_cell,Cell_handle)
  FORWARD_CALL_2_PTR(bool,has_vertex,Facet,Vertex_handle)
  FORWARD_CALL_3_PTR(bool,has_vertex,Cell_handle,int,Vertex_handle)
  FORWARD_CALL_4_PTR(bool,are_equal,Cell_handle,int,Cell_handle,int)
  FORWARD_CALL_2_PTR(bool,are_equal,Facet,Facet)
  FORWARD_CALL_3_PTR(bool,are_equal,Facet,Cell_handle,int)
//Point location
  FORWARD_CALL_1_PTR(Cell_handle,locate,Point)
  FORWARD_CALL_AND_REF_2_PTR(Cell_handle,locate,Point,Cell_handle)
  FORWARD_CALL_AND_REF_2_PTR(Cell_handle,locate,Point,Vertex_handle)
//Flips
  FORWARD_CALL_1_PTR(bool,flip,Edge)
  FORWARD_CALL_3_PTR(bool,flip,Cell_handle,int,int)
  FORWARD_CALL_1_PTR(void,flip_flippable,Edge)
  FORWARD_CALL_3_PTR(void,flip_flippable,Cell_handle,int,int)
  FORWARD_CALL_1_PTR(bool,flip,Facet)
  FORWARD_CALL_2_PTR(bool,flip,Cell_handle,int)
  FORWARD_CALL_1_PTR(void,flip_flippable,Facet)
  FORWARD_CALL_2_PTR(void,flip_flippable,Cell_handle,int)
//Insertions
  FORWARD_CALL_1_PTR(Vertex_handle,insert,Point)
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,insert,Point,Cell_handle)
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,insert,Point,Vertex_handle)
  ...
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,insert_in_cell,Point,Cell_handle)
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,insert_in_facet,Point,Facet)
  FORWARD_CALL_AND_REF_3_PTR(Vertex_handle,insert_in_facet,Point,Cell_handle,int)
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,insert_in_edge,Point,Edge)
  FORWARD_CALL_AND_REF_4_PTR(Vertex_handle,insert_in_edge,Point,Cell_handle,int,int)
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,insert_outside_convex_hull,Point,Cell_handle)
  FORWARD_CALL_AND_REF_1_PTR(Vertex_handle,insert_outside_affine_hull,Point)
...
//Cell and Facet Circulators
  FORWARD_CALL_AND_REF_1_PTR(Cell_circulator,incident_cells,Edge)
  FORWARD_CALL_AND_REF_3_PTR(Cell_circulator,incident_cells,Cell_handle,int,int)
  FORWARD_CALL_AND_REF_2_PTR(Cell_circulator,incident_cells,Edge,Cell_handle)
  FORWARD_CALL_AND_REF_4_PTR(Cell_circulator,incident_cells,Cell_handle,int,int,Cell_handle)
  FORWARD_CALL_AND_REF_1_PTR(Facet_circulator,incident_facets,Edge)
  FORWARD_CALL_AND_REF_3_PTR(Facet_circulator,incident_facets,Cell_handle,int,int)
  FORWARD_CALL_AND_REF_2_PTR(Facet_circulator,incident_facets,Edge,Facet)
  FORWARD_CALL_AND_REF_3_PTR(Facet_circulator,incident_facets,Edge,Cell_handle,int)
  FORWARD_CALL_AND_REF_4_PTR(Facet_circulator,incident_facets,Cell_handle,int,int,Facet)
  FORWARD_CALL_5_PTR(Facet_circulator,incident_facets,Cell_handle,int,int,Cell_handle,int)  
//Traversal of the incident cells, facets and edges, and the adjacent vertices of a given vertex
  ...
  FORWARD_CALL_1_PTR(int,degree,Vertex_handle)  
//Traversal between adjacent cells
  FORWARD_CALL_2_PTR(int,mirror_index,Cell_handle,int)
  FORWARD_CALL_AND_REF_2_PTR(Vertex_handle,mirror_vertex,Cell_handle,int)  
  FORWARD_CALL_AND_REF_1_PTR(Facet,mirror_facet,Facet)
//Geometric access functions
  FORWARD_CALL_AND_REF_1_PTR(Tetrahedron_3,tetrahedron,Cell_handle)
  FORWARD_CALL_AND_REF_2_PTR(Triangle_3,triangle,Cell_handle,int)
  FORWARD_CALL_AND_REF_1_PTR(Triangle_3,triangle,Facet)
  FORWARD_CALL_AND_REF_1_PTR(Segment_3,segment,Edge)
  FORWARD_CALL_AND_REF_3_PTR(Segment_3,segment,Cell_handle,int,int)
  FORWARD_CALL_AND_REF_2_PTR(Point,point,Cell_handle,int)
  FORWARD_CALL_AND_REF_1_PTR(Point,point,Vertex_handle)
//Checking
  FORWARD_CALL_0_PTR(bool,is_valid)
  FORWARD_CALL_1_PTR(bool,is_valid,bool)
  FORWARD_CALL_1_PTR(bool,is_valid,Cell_handle)
  FORWARD_CALL_2_PTR(bool,is_valid,Cell_handle,bool)
//I/O  
