...
%template (Locate_result) Locate_result_wrapper<Voronoi_diagram_2_Vertex_handle_SWIG_wrapper,Voronoi_diagram_2_Halfedge_handle_SWIG_wrapper,Voronoi_diagram_2_Face_handle_SWIG_wrapper>;
