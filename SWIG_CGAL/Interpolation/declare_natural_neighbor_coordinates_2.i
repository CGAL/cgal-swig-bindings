...
Typemap_for_Input_iterator(DT2_Edge_iterator,DT2_Edge_wrapper,Delaunay_triangulation_2_Edge,CGAL_DT2::Edge,SWIGTYPE_p_std__pairT_CGAL_Face_handleT_CGAL_DT2_Point_2_t_int_t,"(LCGAL/Triangulation_2/Delaunay_triangulation_2_Edge;)J",natural_neighbor_coordinates_2)
...
#ifdef SWIGPYTHON
void dummy1(std::pair<CGAL_Face_handle<CGAL_DT2,Point_2>,int>* t); //to have the type SWIGTYPE_p_std__pairT_CGAL_Face_handleT_CGAL_DT2_Point_2_t_int_t defined
#endif

%{
  #ifdef SWIGPYTHON
  void dummy1(std::pair<CGAL_Face_handle<CGAL_DT2,Point_2>,int>* t){std::cout << t->second << std::endl;}
  #endif
