...
%{
  ...
  #else
  typedef Generic_input_iterator< DT2_Edge_wrapper > DT2_Edge_iterator;
...
SWIG_CGAL_input_iterator_typemap_in(DT2_Edge_iterator,DT2_Edge_wrapper,Delaunay_triangulation_2_Edge,CGAL_DT2::Edge,SWIGTYPE_p_std__pairT_SWIG_Triangulation_2__CGAL_Face_handleT_CGAL_DT2_Point_2_t_int_t,"(LCGAL/Triangulation_2/Delaunay_triangulation_2_Edge;)J",natural_neighbor_coordinates_2)
#else
...
%define DT2_Edge_iterator  Generic_input_iterator< DT2_Edge_wrapper > %enddef
//input iterator
%template(Delaunay_triangulation_2_Edge_input_iterator)  Generic_input_iterator< DT2_Edge_wrapper >;
#endif


std::pair<double,bool> natural_neighbor_coordinates_2(const DT2_wrapper& dt,const Point_2& p,iPoint_2_and_double_output_iterator out,const SWIG_Triangulation_2::CGAL_Face_handle<CGAL_DT2,Point_2>& start);
std::pair<double,bool> natural_neighbor_coordinates_2(const DT2_wrapper& dt,const Point_2& p,iPoint_2_and_double_output_iterator out);
std::pair<double,bool> natural_neighbor_coordinates_2(const DT2_wrapper& dt,const SWIG_Triangulation_2::CGAL_Vertex_handle<CGAL_DT2,Point_2>& vh,iPoint_2_and_double_output_iterator out);
std::pair<double,bool> natural_neighbor_coordinates_2(const DT2_wrapper& dt,const Point_2& p,iPoint_2_and_double_output_iterator out,DT2_Edge_iterator its);
#ifdef SWIGPYTHON
...
%{
  ...
  natural_neighbor_coordinates_2(const DT2_wrapper& dt,const Point_2& p,iPoint_2_and_double_output_iterator out,const SWIG_Triangulation_2::CGAL_Face_handle<CGAL_DT2,Point_2>& start)
  {
    return internal::extract_pair( CGAL::natural_neighbor_coordinates_2(dt.get_data(),p.get_data(),out,start.get_data()) );
  }

  std::pair<double,bool> 
  natural_neighbor_coordinates_2(const DT2_wrapper& dt,const Point_2& p,iPoint_2_and_double_output_iterator out)
  {
    return internal::extract_pair( CGAL::natural_neighbor_coordinates_2(dt.get_data(),p.get_data(),out) );
  }

  std::pair<double,bool>
  natural_neighbor_coordinates_2(const DT2_wrapper& dt,const Point_2& p,iPoint_2_and_double_output_iterator out,DT2_Edge_iterator its)
  {
  ...
  std::pair<double,bool> 
  natural_neighbor_coordinates_2(const DT2_wrapper& dt,const SWIG_Triangulation_2::CGAL_Vertex_handle<CGAL_DT2,Point_2>& vh,iPoint_2_and_double_output_iterator out)
  {
