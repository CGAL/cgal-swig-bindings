...
%define RT2_wrapper Regular_triangulation_2_wrapper<CGAL_RT2,CGAL_Vertex_handle<CGAL_RT2,Weighted_point_2>,CGAL_Face_handle<CGAL_RT2,Weighted_point_2> > %enddef
%define RT2_Edge_wrapper std::pair<CGAL_Face_handle<CGAL_RT2,Weighted_point_2>,int>%enddef
...
%define RT2_Vertex_wrapper CGAL_Vertex_handle<CGAL_RT2,Weighted_point_2> %enddef
...
%{
  ...
  typedef Regular_triangulation_2_wrapper<CGAL_RT2,CGAL_Vertex_handle<CGAL_RT2,Weighted_point_2>,CGAL_Face_handle<CGAL_RT2,Weighted_point_2> > RT2_wrapper;
  ...
  typedef std::pair<CGAL_Face_handle<CGAL_RT2,Weighted_point_2>,int> RT2_Edge_wrapper;
  typedef CGAL_Vertex_handle<CGAL_RT2,Weighted_point_2>              RT2_Vertex_wrapper;
...
Typemap_for_Output_iterator(Weighted_point_2_and_double_output_iterator,Weighted_point_2_and_double_wrapper,Weighted_point_2_and_double,Weighted_point_2_and_double_base,SWIGTYPE_p_std__pairT_Weighted_point_2_double_t,"LCGAL/Interpolation/Weighted_point_2_and_double;")
Typemap_for_Input_iterator(RT2_Edge_iterator,RT2_Edge_wrapper,Regular_triangulation_2_Edge,CGAL_RT2::Edge,SWIGTYPE_p_std__pairT_CGAL_Face_handleT_CGAL_RT2_Weighted_point_2_t_int_t,"(LCGAL/Triangulation_2/Regular_triangulation_2_Edge;)J",regular_neighbor_coordinates_2)
Typemap_for_Input_iterator(RT2_Vertex_iterator,RT2_Vertex_wrapper,Regular_triangulation_2_Vertex_handle,CGAL_RT2::Vertex_handle,SWIGTYPE_p_std__pairT_CGAL_Face_handleT_CGAL_RT2_Weighted_point_2_t_int_t,"(LCGAL/Triangulation_2/Regular_triangulation_2_Vertex_handle;)J",regular_neighbor_coordinates_2)

std::pair<double,bool> regular_neighbor_coordinates_2(const RT2_wrapper& dt,const Weighted_point_2& p,Weighted_point_2_and_double_output_iterator out,const CGAL_Face_handle<CGAL_RT2,Weighted_point_2>& start);
...
std::pair<double,bool> regular_neighbor_coordinates_2(const RT2_wrapper& dt,const CGAL_Vertex_handle<CGAL_RT2,Weighted_point_2>& vh,Weighted_point_2_and_double_output_iterator out);
...
#ifdef SWIGPYTHON
void dummy0(std::pair<CGAL_Face_handle<CGAL_RT2,Weighted_point_2>,int>* t); //to have the type SWIGTYPE_p_std__pairT_CGAL_Face_handleT_CGAL_RT2_Weighted_point_2_t_int_t defined
#endif

%{
  #ifdef SWIGPYTHON
  void dummy0(std::pair<CGAL_Face_handle<CGAL_RT2,Weighted_point_2>,int>* t){std::cout << t->second << std::endl;}
  #endif
  
  std::pair<double,bool> 
  regular_neighbor_coordinates_2(const RT2_wrapper& dt,const Weighted_point_2& p,Weighted_point_2_and_double_output_iterator out,const CGAL_Face_handle<CGAL_RT2,Weighted_point_2>& start)
  {
  ...
  std::pair<double,bool> 
  regular_neighbor_coordinates_2(const RT2_wrapper& dt,const CGAL_Vertex_handle<CGAL_RT2,Weighted_point_2>& vh,Weighted_point_2_and_double_output_iterator out)
  {
