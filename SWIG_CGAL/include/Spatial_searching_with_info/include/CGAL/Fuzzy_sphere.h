...
//
// $URL: svn+ssh://sloriot@scm.gforge.inria.fr/svn/cgal/branches/experimental-packages/Spatial_searching_with_info/Spatial_searching/include/CGAL/Fuzzy_sphere.h $
// $Id: Fuzzy_sphere.h 60456 2010-12-22 09:09:20Z sloriot $
// 
//
  ...
  class Fuzzy_sphere{
	...
	{ 	// avoid problems if eps > r
		if (eps>r) eps=r; 
                ...
                dim = static_cast<int>(std::distance(ccci(center), ccci(center,0)));          
	}
